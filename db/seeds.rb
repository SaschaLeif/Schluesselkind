...
:rating => 0.00,
:info_text => '"Gain Knowledge - Take Action", so lautet die Philosophie von KnowledgeCotton Apparel. Vor &uuml;ber 40 Jahren begann die Erfolgsgeschichte eines Unternehmers in einem kleinen Dorf im S&uuml;den D&auml;nemarks. Knowledge Cotton Apparel - wenn Leidenschaft, Verantwortung und Umweltbewusstsein mit Design und h&ouml;chsten Anspr&uuml;chen an Qualit&auml;t vereint wird, entsteht Knowledge Cotton Apparel. Das Familienunternehmen hatte sich das Ziel gesetzt, fundamentale Standards in der Produktion von Baumwolle als Philosophie und Qualit&auml;tsstandard zu verfolgen. Die Leidenschaft f&uuml;r Qualit&auml;t eint alle knowledge cotton apparel Mitarbeiter und bleibt auch nach &uuml;ber vier Jahrzehnten der Anspruch an jedes Shirt, jede Jeans, jede Weste jeden Hoodie und jedes Paar Socken, welches die Fabrik verl&auml;sst.'
)
